/*
 * task_Si5338_RegMap_MCU_8MHz.h
 *
 *  Created on: 27.08.2018
 *      Author: DF4IAH
 */

#ifndef SI5338_MCO_8MHZ_H_
#define SI5338_MCO_8MHZ_H_
...
//#BEGIN_HEADER
//Date = Sunday, September 02, 2018 8:33 PM
//File version = 3
...
//Part Number = Si533x
//#END_HEADER
//Input Frequency (MHz) = 8.000000000
//Input Type = CMOS_SSTL_HSTL
//P1 = 1
//Input Mux = RefClk
//FDBK Input Frequency (MHz) = 8.000000000
//FDBK Input Type = OFF
//P2 = 1
//FDBK Mux = NoClk
//PFD Input Frequency (MHz) = 8.000000000
...
#define SI5338_MCU_8MHZ_NUM_REGS_MAX 350


#endif /* SI5338_MCO_8MHZ_H_ */
